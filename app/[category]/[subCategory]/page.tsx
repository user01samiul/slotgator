...
interface Section {
  ...
  cards?: { title: string; description?: string; image?: string; numbers?: string }[];
  moreRegions?: string;
}
...
const SubCategories = async ({ params }: SubCategoriesProps) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-white">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg">
          ...
          <p className="text-xl text-gray-600 mb-8">The requested page does not exist.</p>
          <Link
            href="/"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* Dynamic Sections */}
      {Object.entries(sections).map(([sectionKey, section]: [string, Section]) => (
        <section
          key={sectionKey}
          className={`py-16 md:py-20 ${parseInt(sectionKey.replace('section', '')) % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}
        >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <button className="border-2 border-white text-white hover:bg-white/10 px-8 py-3 rounded-md font-semibold transition duration-300">
                Request Demo
              </button>
            </div>
          </div>
